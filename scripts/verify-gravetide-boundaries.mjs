...
const showcaseRoot = path.join(root, "showcases", "gravetide");
...
assert.deepEqual(
  violations,
  [],
  `Gravetide must use documented public package entrypoints:\n${violations.join("\n")}`,
);
console.log("Gravetide public-import boundary verified");
