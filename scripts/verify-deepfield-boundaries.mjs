...
const showcaseRoot = path.join(root, "showcases", "deepfield");
...
assert.deepEqual(
  violations,
  [],
  `Deepfield must use documented public package entrypoints:\n${violations.join("\n")}`,
);
console.log("Deepfield public-import boundary verified");
