...
const showcaseRoot = path.join(root, "showcases", "craftlands");
...
assert.deepEqual(
  violations,
  [],
  `Craftlands must use documented public package entrypoints:\n${violations.join("\n")}`,
);
console.log("Craftlands public-import boundary verified");
