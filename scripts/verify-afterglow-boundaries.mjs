...
const showcaseRoot = path.join(root, "showcases", "afterglow");
...
assert.deepEqual(
  violations,
  [],
  `Afterglow must use documented public package entrypoints:\n${violations.join("\n")}`,
);
console.log("Afterglow public-import boundary verified");
